    ...
    <div className="p-6 space-y-6 min-h-screen bg-background">
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab}>
        <TabsList className="grid w-full grid-cols-4 lg:w-[500px] rounded-t-lg">
          <TabsTrigger value="overview" className="data-[state=active]:bg-admin data-[state=active]:text-admin-foreground data-[state=active]:border-admin font-medium gap-2 text-admin/70 hover:text-admin py-3 pb-3 rounded-tl-lg">             
            <BarChart3 className="w-4 h-4" />
            Overview</TabsTrigger>
          <TabsTrigger value="attendance" className="data-[state=active]:bg-admin data-[state=active]:text-admin-foreground data-[state=active]:border-admin font-medium gap-2 text-admin/70 hover:text-admin py-3 pb-3">
            <Calendar className="w-4 h-4" />
            Attendance</TabsTrigger>
          <TabsTrigger value="task-reports" className="data-[state=active]:bg-admin data-[state=active]:text-admin-foreground data-[state=active]:border-admin font-medium gap-2 text-admin/70 hover:text-admin py-3 pb-3">
            <CheckSquare className="w-4 h-4" />
            Task Reports</TabsTrigger>
          <TabsTrigger value="projects" className="data-[state=active]:bg-admin data-[state=active]:text-admin-foreground data-[state=active]:border-admin font-medium gap-2 text-admin/70 hover:text-admin py-3 pb-3 rounded-tr-lg">
