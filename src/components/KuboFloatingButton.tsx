      ...
      <Tooltip>
        <TooltipTrigger asChild>
          <div
            ...
            className="fixed bottom-6 right-6 h-16 w-16 rounded-full shadow-[0_8px_30px_rgb(0,0,0,0.3)] hover:shadow-[0_12px_40px_rgb(0,0,0,0.4)] transform hover:scale-110 transition-all duration-200 z-40 cursor-pointer overflow-hidden"
          >
