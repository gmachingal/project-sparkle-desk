...
const Header = () => {
  ...
  return (
    <header className="border-b bg-gradient-to-r from-primary/30 via-primary-glow/20 to-primary/30 backdrop-blur-sm sticky top-0 z-50 border-border/50 shadow-lg">
