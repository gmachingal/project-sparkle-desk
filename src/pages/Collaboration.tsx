        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
          ...
          <TabsContent value="learning" className="space-y-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              {currentUser.role === 'admin' && (
                <Card className="border-purple-500/20 bg-gradient-to-br from-purple-500/5 to-purple-400/10 hover:from-purple-500/10 hover:to-purple-400/20 transition-all duration-300 cursor-pointer group">
                  <Dialog open={isCreateProgramOpen} onOpenChange={setIsCreateProgramOpen}>
                    <DialogTrigger asChild>
                      <div className="h-full">
                        <CardHeader className="text-center pb-3">
                          <div className="w-16 h-16 mx-auto rounded-full bg-purple-500/20 flex items-center justify-center mb-4 group-hover:scale-110 transition-transform">
                            <Plus className="w-8 h-8 text-purple-500" />
                          </div>
                          <CardTitle className="text-xl">Create Program</CardTitle>
                          <p className="text-sm text-muted-foreground">Build learning programs with assessments</p>
                        </CardHeader>
                        <CardContent className="space-y-3">
                          <div className="bg-background/50 rounded-lg p-3">
                            <div className="text-sm font-medium mb-1">Admin Tool</div>
                            <div className="text-xs text-muted-foreground">Create custom learning programs</div>
                          </div>
                          <div className="text-center">
                            <div className="text-2xl font-bold text-purple-500">Build</div>
                            <div className="text-xs text-muted-foreground">Custom Programs</div>
                          </div>
                          <Button className="w-full group-hover:shadow-md transition-shadow" variant="outline">
            ...
            <div className="space-y-6">
              ...
              <Card className="border-purple-500/20">
                ...
                <CardContent className="space-y-4">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                      <Label htmlFor="program-level">Difficulty Level</Label>
                  ...
                  <div>
                    ...
                    <Textarea
                      ...
                      placeholder="Describe the learning program objectives and content..."
                      className="bg-background min-h-[100px]"
                    />
                  </div>
                  <div>
                    <Label htmlFor="program-duration">Duration (hours)</Label>
                    <Input
                      id="program-duration"
                      type="number"
              ...
              <Card className="border-accent/20">
                <CardHeader>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Create assessments to evaluate learner progress
                  </p>
                </CardHeader>
                <CardContent className="space-y-4">
                  {/* Current Assessment Builder */}
                        ...
                        <Button
                          onClick={() => {
                            if (currentAssessment.title && currentAssessment.questions[0].question) {
                              setProgramAssessments(prev => [...prev, { ...currentAssessment, id: Date.now() }]);
                  ...
                  {programAssessments.length > 0 && (
                    <div className="space-y-2">
                      <Label className="text-base font-semibold">Program Assessments ({programAssessments.length})</Label>
              ...
              <div className="flex gap-2 pt-4">
                <Button
                  onClick={() => {
                    if (programTitle && programDescription && programAssessments.length > 0) {
                      toast({
                        ...
                        description: `"${programTitle}" has been created with ${programAssessments.length} assessments`,
                      });
                  ...
                  disabled={!programTitle || !programDescription || programAssessments.length === 0}
                  className="flex-1"
                >
                  <GraduationCap className="w-4 h-4 mr-2" />
                  Create Program
