...
import reposeLogo from "@/assets/repose-logo-enormous-font.png";
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground text-sm mt-2">
            Project Management & HR Application
          </p>
        </div>
        ...
        <Card className="border-border/50 shadow-xl backdrop-blur-sm bg-card/95">
          ...
          <CardContent>
            <form onSubmit={handleLogin} className="space-y-4">
              ...
              {/* Login Button */}
              <Button type="submit" className="w-full gap-2 bg-gradient-to-r from-primary to-secondary hover:from-primary/90 hover:to-secondary/90">
                Sign In
